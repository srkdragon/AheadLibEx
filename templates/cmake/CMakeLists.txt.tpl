...
set(AHEADLIBEX_RUNTIME_CPP "{{RUNTIME_CPP_SRC}}")
set(AHEADLIBEX_PATCH_CPP "{{PATCH_CPP_SRC}}")
...
add_library(${PROJECT_NAME} SHARED
  "${CMAKE_CURRENT_LIST_DIR}/${AHEADLIBEX_RUNTIME_CPP}"
  "${CMAKE_CURRENT_LIST_DIR}/${AHEADLIBEX_PATCH_CPP}"
